...
{
    public class DrawableTournamentMatchFullName : CompositeDrawable
    {
        public readonly TournamentMatch Match;
        private readonly bool editor;
        protected readonly FillFlowContainer<DrawableMatchTeamFullName> Flow;
        ...
        public DrawableTournamentMatchFullName(TournamentMatch match, bool editor = false)
        {
            Match = match;
            this.editor = editor;
            ...
            InternalChildren = new[]
            {
                ...
                Flow = new FillFlowContainer<DrawableMatchTeamFullName>
                {
                    AutoSizeAxes = Axes.Both,
        ...
        private void updateTeams()
        {
            ...
            Flow.Children = new[]
            {
                new DrawableMatchTeamFullName(Match.Team1.Value, Match, Match.Losers.Value),
                new DrawableMatchTeamFullName(Match.Team2.Value, Match, Match.Losers.Value)
            };
